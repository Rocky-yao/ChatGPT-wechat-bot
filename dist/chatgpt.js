...
export default class ChatGPT {
    ...
    chatOption;
    constructor() {
        this.chatGPT = new ChatGPTClient(config.OPENAI_API_KEY, {
            ...clientOptions,
    ...
    async getChatGPTReply(content, contactId) {
        const data = await this.chatGPT.sendMessage(content, this.chatOption[contactId]);
    ...
    async replyMessage(contact, content) {
        ...
        try {
            if (content.trim().toLocaleLowerCase() ===
